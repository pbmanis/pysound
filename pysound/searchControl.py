...
class Controller(object):
    ...
    def stimulus_count(self):
        self.status.N_stimuli += 1
        self.maingui.stimulus_counter.setText(f"{self.status.N_stimuli:4d}")
    ...
    def stop_stim(self):
        ...
        """
        self.PS.stop_nidaq()
        self.maingui.label_status.setText("Stim Stopped")
    ...
    def stop_run(self):
        ...
        """
        self.PS.stop_stim()
        self.maingui.label_status.setText("Acquisiton Stopped")
...
class BuildGui:
    def __init__(self):
        ...
        self.btn_run_preview = QtGui.QPushButton("Run Preview")
        self.btn_run_record = QtGui.QPushButton("Run Record")
        ...
        hbox.addWidget(self.btn_run_record,  1, 2, 1, 1)
        hbox.addWidget(self.btn_stop,        2, 2, 1, 1)
        ...
        self.controller.getAllParameters(params)  # synchronize parameters with the tree
